...
const TabIcon = ({focused , name , image})=>{
    return(
        <View style={styles.tabView}>
            ...
            <Image tintColor={focused ? COLORS.red: COLORS.grey}
             style={styles.tabIcon} source={image}/>
            {
                focused ? <Image tintColor={COLORS.red} 
...
const styles = StyleSheet.create({
    tabView:{
        alignItems:'center',  width:Dimensions.get('screen').width * 0.25,
         marginTop:20, gap:8
